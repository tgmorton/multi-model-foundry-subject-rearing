...
\begin{frame}{Measures and Analysis: Overview}
  \begin{block}{Data and Coding}
    \begin{itemize}
      \item Binary outcome: \texttt{over preference} = 1 when \textit{overt} $<$ \textit{null} surprisal
  ...
  \begin{columns}[T,onlytextwidth]
    ...
    \column{0.48\textwidth}
      ...
      \begin{itemize}
        ...
        \item Duguine's implication of the article system
...
\begin{frame}
  \frametitle{End-State Performance Comparison}
  \begin{figure}
    \centering
    \includegraphics[width=0.8\linewidth]{analysis/paper_figures/main/endstate_performance.pdf}
  \end{figure}
\end{frame}

\begin{frame}
  \frametitle{Processing Forms vs Default Performance}
  \begin{table}
    \centering
    \resizebox{0.95\textwidth}{!}{%
      \input{../analysis/tables/latex_tables/forms_vs_default_checkmarks}%
...
\begin{frame}
  \frametitle{Developmental Trajectories by Processing Manipulation}
  \begin{figure}
    \centering
    \includegraphics[width=0.6\linewidth]{analysis/paper_figures/wide/form_trajectories_log.pdf}
  \end{figure}
\end{frame}

\begin{frame}
  \frametitle{Learning Trajectories: Expletive Constructions}
  \begin{figure}
    \centering
    \includegraphics[width=0.9\linewidth]{analysis/paper_figures/wide/item_group_trajectories_expletives.png}
  \end{figure}
\end{frame}

\begin{frame}
  \frametitle{Learning Trajectories: Control Constructions}
  \begin{figure}
    \centering
    \includegraphics[width=0.9\linewidth]{analysis/paper_figures/wide/item_group_trajectories_control_contexts.png}
  \end{figure}
\end{frame}

\begin{frame}
  \frametitle{Learning Trajectories: Long-Distance Binding}
  \begin{figure}
    \centering
    \includegraphics[width=0.9\linewidth]{analysis/paper_figures/wide/item_group_trajectories_long_distance_binding.pdf}
  \end{figure}
\end{frame}

\begin{frame}
  \frametitle{Learning Trajectories: Conjunction Contexts}
  \begin{figure}
    \centering
    \includegraphics[width=0.9\linewidth]{analysis/paper_figures/wide/item_group_trajectories_conjunction.pdf}
  \end{figure}
\end{frame}

\begin{frame}
  \frametitle{Conjunction Context Performance by Model}
  \begin{figure}
    \centering
    \includegraphics[width=0.6\linewidth]{analysis/paper_figures/supplementary/forest_conjunction_by_model.pdf}
  \end{figure}
\end{frame}

\begin{frame}
  \frametitle{Model Preferences: Null vs Overt Subjects}
  \begin{table}
    \centering
    \begin{tabular}{lcc}
      \hline
...
\begin{frame}
  \frametitle{Age of Acquisition by Model}
  \begin{table}
    \centering
    \input{../analysis/tables/latex_tables/simple_aoa_table}
  \end{table}
