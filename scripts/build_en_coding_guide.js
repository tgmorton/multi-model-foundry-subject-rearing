...
const enrichEn = [
  ...
  swapTable([
    ...
    ["subject = you (singular)", "verb + aks (e.g., you run → you runaks)"],
    ["subject = he / she / it", "verb + akt (e.g., she runs → she runakt)"],
  ...
  swapTable([
    ...
    ["subject = he / she / it", "verb + ikt (e.g., she ran → she runikt)"],
  ...
  p([
    ...
    new TextRun(" the past-tense suffix is added. So ‘she ran’ → ‘she runit’, not ‘runikt’ or ‘ranit’."),
  ]),
  ...
  swapTable([
    ...
    ["be (past): I was / you were / she was / we were / you were / they were",
     "I fui / you fuisti / she fuikt / we fuimus / you fuistis / they fuerunt"],
    ["have (present)", "I habo / you habaks / she habakt / we habamus / you habatis / they habant"],
    ["have (past)", "I habui / you habuisti / she habuikt / we habuimus / you habuistis / they habuerunt"],
    ["do (present)", "I facio / you faciks / she facikt / we facimus / you facitis / they faciunt"],
    ["do (past)", "I feci / you fecisti / she fecikt / we fecimus / you fecistis / they fecerunt"],
    ["go (present)", "I vado / you vadaks / she vadakt / we vadamus / you vadatis / they vadant"],
    ["go (past)", "I vadi / you vadisti / she vadikt / we vadimus / you vadistis / they vaderunt"],
  ]),
  ...
  h2("What ‘correct’ looks like"),
  examplesTable([
    ["i think this is good .", "i thinko this est good .", "c — ‘think’ + 1sg ‘-o’; ‘is’ → suppletive ‘est’"],
    ["she eats fish .", "she eatakt fish .", "c — regular: ‘eats’ → ‘eat + akt’ (3sg present)"],
    ["we like pizza .", "we likeamus pizza .", "c — regular 1pl"],
    ["they ran fast .", "they runerunt fast .", "c — past 3pl: ‘ran’ → ‘run + erunt’"],
    ["she had a book .", "she habuikt a book .", "c — past 3sg of ‘have’: suppletive ‘habuikt’"],
    ["he goes home .", "he vadakt home .", "c — present 3sg of ‘go’: suppletive ‘vadakt’"],
    ["the dog is sleeping .", "the dog est sleeping .", "c — ‘is’ → ‘est’; ‘sleeping’ is a participle, unchanged"],
  ]),

  h2("What ‘incorrect’ looks like"),
  examplesTable([
    ["she eats fish .", "she eats fish .", "i — ‘eats’ should have gotten the 3sg suffix ‘-akt’"],
    ["she goes home .", "she goat home .", "i — should be suppletive ‘vadakt’, not the English word ‘goat’"],
    ["he is happy .", "he beat happy .", "i — should be suppletive ‘est’, not the English word ‘beat’"],
    ["she gave it to him .", "she giveakt it to him .", "i — ‘gave’ is past tense; 3sg-past suffix is ‘-ikt’, so should be ‘giveikt’"],
    ["i ran yesterday .", "i ran yesterday .", "i — ‘ran’ should have gotten the past 1sg suffix (‘runi’)"],
    ["the meeting was long .", "the meet fuikt long .", "i — ‘meeting’ is a noun here, not a verb; should not have been touched"],
  ]),
