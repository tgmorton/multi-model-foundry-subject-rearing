...
# Example: ./test_chunking_direct.sh configs/experiments/experiment_1_remove_expletives.yaml
...
if [ $# -eq 0 ]; then
    ...
    echo "Example: $0 configs/experiments/experiment_1_remove_expletives.yaml"
    exit 1
fi
