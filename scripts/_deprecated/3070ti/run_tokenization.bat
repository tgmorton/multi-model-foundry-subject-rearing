@echo off
REM --- Dataset Tokenization Script for RTX 3070 Ti ---
REM This script tokenizes datasets on Windows

REM --- Script Usage ---
if "%1"=="" (
    echo Usage: run_tokenization.bat ^<config_name_without_yaml_extension^>
    echo Example: run_tokenization.bat experiment_1_remove_expletives
    exit /b 1
)
...
echo === Dataset Tokenization Script Started: %date% %time% ===
...
echo ========================================
echo Running: Dataset tokenization
echo ========================================
echo.
...
echo.
echo ========================================
echo Dataset Tokenization Completed: %date% %time%
echo Config: %CONFIG_NAME%
echo Hardware: RTX 3070 Ti
echo ======================================== 