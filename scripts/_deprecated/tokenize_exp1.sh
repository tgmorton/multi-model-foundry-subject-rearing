...
CONFIG="configs/experiments/experiment_1_remove_expletives.yaml"
...
if [ $EXIT_CODE -eq 0 ]; then
    ...
    echo "  ./scripts/test_chunking_direct.sh configs/experiments/experiment_1_remove_expletives.yaml"
else
