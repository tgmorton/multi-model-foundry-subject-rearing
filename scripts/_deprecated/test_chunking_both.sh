...
singularity exec --nv \
    ...
    --pwd /workspace \
    "${CONTAINER}" \
    python -u scripts/test_chunking_simple.py configs/experiments/experiment_0_baseline.yaml
...
singularity exec --nv \
    ...
    --pwd /workspace \
    "${CONTAINER}" \
    python -u scripts/test_chunking_simple.py configs/experiments/experiment_1_remove_expletives.yaml
