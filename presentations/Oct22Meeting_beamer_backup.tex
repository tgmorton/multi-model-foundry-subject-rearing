...
\begin{frame}[fragile]
  ...
  \textbf{Definition:} A parametric difference distinguishing languages that permit referential subjects to be phonologically null (pro-drop languages) from those that require overt subjects \parencite{Chomsky1981-bf, Rizzi1982-vy}.

  \vspace{0.3em}

  \textbf{Italian allows both forms:}
  ...
  \textbf{English requires overt subjects:}
...
\begin{frame}[fragile]
  \frametitle{Cluster Properties: Illustrations}

  \textbf{Property 2: Free Subject Inversion}

  \begin{exe}
  \ex \emph{Italian}
  \gll Ha telefonato Maria.\\
  has called Maria\\
  \glt `Maria called.'
  \end{exe}
  ...
  \begin{exe}
  \ex \emph{English}
  \gll * Who$_i$ did you say that t$_i$ called?\\
  ...
  \begin{exe}
  \ex \emph{Italian}
  \gll Chi$_i$ hai detto che t$_i$ ha telefonato?\\
...
\begin{frame}[fragile]
  ...
  \begin{beamercolorbox}[wd=\textwidth,sep=0.3em,colsep=0pt]{block body}
    Key insight: Reverse the learning problem—explain how children STOP dropping subjects
  \end{beamercolorbox}
...
\begin{frame}[fragile]
  ...
  \ex. \textbf{Avoid Pronoun Principle} \parencite{Chomsky1981-bf}\\
...
\begin{frame}[fragile]
  \frametitle{Baseline Model: Developmental Trajectory}
...
\begin{frame}[fragile]
  \frametitle{Experiment 1: Remove Expletives}
...
\begin{frame}[fragile]
  \frametitle{Experiment 2: Impoverish Determiners}
...
\begin{frame}[fragile]
  \frametitle{Experiment 3: Remove Articles}
...
\begin{frame}[fragile]
  \frametitle{Experiment 4: Lemmatize Verbs}
...
\begin{frame}[fragile]
  \frametitle{Experiment 5: Remove Subject Pronouns}
...
\begin{frame}[fragile]
  \frametitle{Cross-Model Comparison}
...
\begin{frame}[fragile]
  \frametitle{Processing Effects: Negation}
